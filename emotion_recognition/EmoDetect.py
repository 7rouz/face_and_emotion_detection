...
def Predict_Emotion(filename):
    ...
    for k,d in enumerate(dets):
        ...
        features= numpy.asarray(features).reshape(1,-1)
    ...
    # TODO FIX Waitkey because it seems that it doesn't work
    cv2.waitKey(0)
...
if __name__ == "__main__":
    ...
    if not os.path.isfile("shape_predictor_68_face_landmarks.dat"):
        # Retrieve shape_predictor_68_face_landmarks.dat
        urllib.urlretrieve("https://raw.githubusercontent.com/tzutalin/dlib-android/master/data/shape_predictor_68_face_landmarks.dat", "shape_predictor_68_face_landmarks.dat")
